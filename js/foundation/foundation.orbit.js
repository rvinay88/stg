  ...
  var Orbit = function(el, settings) {
    ...
    self.build_markup = function() {
      ...
      if (settings.navigation_arrows) {
        container.append($('<div>').addClass(settings.prev_class).addClass('left').append('<span>'));
        container.append($('<div>').addClass(settings.next_class).addClass('right')append('<span>'));
      }
