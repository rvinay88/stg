...
(function(n){"use strict";n.fn.cycle.transitions.scrollVert={before:function(n,t,i,r){n.API.stackSlides(n,t,i,r);var u=n.container.css("overflow","hidden").height();n.cssBefore={top:r?-u:u,left:0,opacity:1,display:"block"},n.animIn={top:0},n.animOut={top:r?u:-u}}}})(jQuery);
/*! Cycle2 lookahead plugin; Copyright (c) M.Alsup, 2013; version: 20130317 */
(function(n){"use strict";n(document).on("cycle-initialized",function(t,i){var r="cycle-look-ahead";i.container.on("cycle-before",function(t,i,u,f,e){var h=e?i.nextSlide+1:i.nextSlide-1,o=n(i.slides[h]),s;o.length&&!o.data(r)&&(o.data(r,!0),s=o.is("img[data-cycle-src]")?o:o.find("img[data-cycle-src]"),s.each(function(){var t=n(this);t.attr("src",t.attr("data-cycle-src")),t.removeAttr("data-cycle-src")}))})})})(jQuery)